...
char tempMsg[50], heapMsg[50], latMsg[50], lonMsg[50], speedMsg[50], altMsg[50], c, pressureMsg[50] = {0};
const char* topicStr;
...
void setup() {
    ...
    Serial2.begin(9600, SERIAL_8N1, 44, 43);  // Initialize Serial2 for MH-Z19B
...
void callback(char* topic, byte* payload, unsigned int length) {
    ...
    } else if (strcmp(topic, "/Wasserversorgung") == 0) {
        Wasserversorgung = strcmp((char*)payload, "true") == 0;
    } else if (strcmp(topic, "/Boilerheizung") == 0) {
        Boilerheizung = strcmp((char*)payload, "true") == 0;
    } else if (strcmp(topic, "/UVCLicht") == 0) {
        UVCLicht = strcmp((char*)payload, "true") == 0;
    } else if (strcmp(topic, "/MinDruck") == 0) {
        MinDruck = atof((char*)payload);
    } else if (strcmp(topic, "/Kuehlschrankgross") == 0) {
        Kuehlschrankgross = strcmp((char*)payload, "true") == 0;
    } else if (strcmp(topic, "/Kuehlschrankklein") == 0) {
        Kuehlschrankklein = strcmp((char*)payload, "true") == 0;
    } else if (strcmp(topic, "/Inverter") == 0) {
